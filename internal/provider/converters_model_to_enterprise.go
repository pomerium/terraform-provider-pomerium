...
func (c *ModelToEnterpriseConverter) Settings(src SettingsModel) *enterprise.Settings {
	return &enterprise.Settings{
		...
		AuthorizeServiceUrl:           c.NullableString(src.AuthorizeServiceURL),
		...
		CacheServiceUrl:               c.NullableString(src.CacheServiceURL),
		...
		CircuitBreakerThresholds:      c.CircuitBreakerThresholds(src.CircuitBreakerThresholds),
		ClientCa:                      c.NullableString(src.ClientCA),
		ClientCaFile:                  c.NullableString(src.ClientCAFile),
		ClientCaKeyPairId:             c.NullableString(src.ClientCAKeyPairID),
		ClusterId:                     c.NullableString(src.ClusterID),
		...
		CookieSecure:                  c.NullableBool(src.CookieSecure),
		...
		DatabrokerServiceUrl:          c.NullableString(src.DatabrokerServiceURL),
		...
		IdpServiceAccount:               c.NullableString(src.IdpServiceAccount),
