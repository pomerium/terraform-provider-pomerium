...
func (c *APIToModelConverter) Settings(src *pomerium.Settings) SettingsModel {
	return SettingsModel{
		...
		DatabrokerStorageConnectionString: types.StringPointerValue(src.DatabrokerStorageConnectionString),
		...
		HeadersWithUnderscoresAction:    c.HeadersWithUnderscoresAction(src.HeadersWithUnderscoresAction),
		...
		LogoURL:                         types.StringPointerValue(src.LogoUrl),
		MergeSlashes:                    types.BoolPointerValue(src.MergeSlashes),
		...
		NamespaceID:                     types.StringPointerValue(src.NamespaceId),
		NormalizePath:                   types.BoolPointerValue(src.NormalizePath),
		...
		PassIdentityHeaders:             types.BoolPointerValue(src.PassIdentityHeaders),
		PathWithEscapedSlashesAction:    c.PathWithEscapedSlashesAction(src.PathWithEscapedSlashesAction),
