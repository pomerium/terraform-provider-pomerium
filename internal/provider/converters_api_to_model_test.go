	...
	t.Run("Settings", func(t *testing.T) {
		...
		t.Run("properties", func(t *testing.T) {
			...
			result := provider.NewAPIToModelConverter(&diagnostics).Settings(&pomerium.Settings{
				...
				CertificateAuthority:       proto.String("CA_CERT"),
				ClusterId:                  proto.String("CLUSTER_ID"),
				CookieDomain:               proto.String(".example.com"),
				CookieExpire:               durationpb.New(24 * time.Hour),
				CookieHttpOnly:             proto.Bool(true),
				CookieName:                 proto.String("_pomerium"),
				CookieSameSite:             proto.String("lax"),
				CookieSecret:               proto.String("SECRET"),
				DefaultUpstreamTimeout:     durationpb.New(30 * time.Second),
				ErrorMessageFirstParagraph: proto.String("ACCESS_DENIED"),
				GrpcAddress:                proto.String(":5443"),
				GrpcInsecure:               proto.Bool(false),
				HttpRedirectAddr:           proto.String(":80"),
				Id:                         proto.String("SETTINGS_ID"),
				IdpClientId:                proto.String("IDP_CLIENT_ID"),
				IdpClientSecret:            proto.String("IDP_CLIENT_SECRET"),
				IdpProvider:                proto.String("google"),
				IdpProviderUrl:             proto.String("https://accounts.google.com"),
				InsecureServer:             proto.Bool(false),
				InstallationId:             proto.String("INSTALLATION_ID"),
				JwtClaimsHeaders:           map[string]string{"X-Email": "email"},
				LogLevel:                   proto.String("info"),
				LogoUrl:                    proto.String("https://example.com/logo.png"),
				MetricsAddress:             proto.String(":9090"),
				PassIdentityHeaders:        proto.Bool(true),
				PrimaryColor:               proto.String("#000000"),
				ProxyLogLevel:              proto.String("debug"),
				RequestParams:              map[string]string{"param1": "value1"},
				Scopes:                     []string{"openid", "profile"},
				SecondaryColor:             proto.String("#FFFFFF"),
				SetResponseHeaders:         map[string]string{"X-Frame-Options": "DENY"},
				SkipXffAppend:              proto.Bool(false),
				SshAddress:                 proto.String(":22"),
				SshUserCaKey:               proto.String("SSH_CA_KEY"),
